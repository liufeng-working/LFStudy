//
//  LFMagicalRecordViewController.m
//  CoreData1
//
//  Created by 刘丰 on 2017/10/23.
//  Copyright © 2017年 liufeng. All rights reserved.
//

#import "LFMagicalRecordViewController.h"
...
@interface LFMagicalRecordViewController ()

@end

@implementation LFMagicalRecordViewController
...
- (IBAction)insert:(id)sender {
    ...
    LFEmployee *emp = [LFEmployee MR_createEntity];
    [LFEmployee MR_requestAllWithPredicate:nil];
