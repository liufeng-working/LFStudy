...
@interface LFPhotoBrowserExtraView ()
...
@implementation LFPhotoBrowserExtraView
...
- (void)save
{
    if ([self.delegate respondsToSelector:@selector(photoBrowserExtraViewDidClickSave:)]) {
        [self.delegate photoBrowserExtraViewDidClickSave:self];
    }
}
